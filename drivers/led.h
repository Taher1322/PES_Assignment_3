 ...
 *
 *
 * Description :	This function initializes WHITE led as ON
 *
 * Inputs: NONE
 *
 * Return: NONE
 ...
 *
 *
 * Description :	This function initializes WHITE led as OFF
 *
 * Inputs: NONE
 *
 * Return: NONE
...
/*************************************************************************************************************
 *
 * Name :		  	void TSI_slider_read_FSM()
 *
 *
 *
 * Description :	This function reads the Touch Slider values in continuous mode
 * This function works on the concept of Finite State Machine which changes the state as soon as it is detected by user input
 * The function controls the RGB led based on certain threshold values which are as follows
 * Left side of slider controls the RED LED
 * Center of slider control the GREEN LED
 * Right side of slider controls the BLUE LED
 * If no user input then WHITE LED blinks
 *
 * Inputs: NONE
 *
 * Return: NONE
